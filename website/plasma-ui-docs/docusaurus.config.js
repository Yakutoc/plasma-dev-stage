...
const { PREFIX, VERSION_NAME } = process.env;
const prefix = VERSION_NAME || !PREFIX ? '' : `/${PREFIX}`;
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/plasma-ui-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/plasma-ui'],
                            path: '',
                        },
                    },
                },
